...
int main(int argc, char *argv[])
{
	...
	printer::inst()->print_str("\n\n");
	printer::inst()->print_str("Brought to you by dace, fireice_uk and psychocrypt under GPLv3.\n");
	printer::inst()->print_str("Based on CPU mining code by wolf9466 (heavily optimized by fireice_uk).\n");
	
	set_colour(K_BLUE);
	printer::inst()->print_str("Pool donation removed by Dace. Manual coin donation options in README. Please support us.\n");
	set_colour(K_WHITE);
#ifndef CONF_NO_CUDA
